...
public:
    ...
    void setupUi(QDialog *Settings)
    {
        ...
        ckDTR = new QCheckBox(Settings);
        ckDTR->setObjectName("ckDTR");

        gridLayout->addWidget(ckDTR, 8, 1, 1, 1);
    ...
    void retranslateUi(QDialog *Settings)
    {
        ...
        ckDTR->setText(QCoreApplication::translate("Settings", "Set DTR", nullptr));
    } // retranslateUi
